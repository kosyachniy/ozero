...
values = {'out':0, 'count':10, 'time_offset':36000}
...
for i in range(200):
    ...
    for item in res['items']:
        ...
        if proverka("Как Сделать Ход", words):
            mess(id, 'Ваше сообщение должно начинаться со слова "Ход". Далее через пробел необязательное целое число - дата, за какой день делается ход.\n'
